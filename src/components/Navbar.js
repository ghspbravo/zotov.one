  ...
  render() {
    if (window.innerWidth > 992) return (
      <nav id='desktop_nav' style={{ position: 'fixed', zIndex: 10, display: 'flex', transformOrigin: 'left', transform: 'rotate(-90deg) translate(-100%, 100%)' }}>
        <a href="#container" style={{ textDecoration: 'none', color: this.state.current === 0 ? 'white' : '#b7b3b3', margin: '0 1vh', fontSize: '20px', fontWeight: '100' }}>
          {this.props.t("navbar.home")}
        </a>
        <a href="#history" style={{ textDecoration: 'none', color: this.state.current === 1 ? '#363BAE' : '#b7b3b3', margin: '0 1vh', fontSize: '20px', fontWeight: '100' }}>
          {this.props.t("navbar.history")}
        </a>
        <a href="#portfolio" style={{ textDecoration: 'none', color: this.state.current === 2 ? '#363BAE' : '#b7b3b3', margin: '0 1vh', fontSize: '20px', fontWeight: '100' }}>
          {this.props.t("navbar.portfolio")}
        </a>
        <a href="#skills" style={{ textDecoration: 'none', color: this.state.current === 3 ? 'white' : '#b7b3b3', margin: '0 1vh', fontSize: '20px', fontWeight: '100' }}>
          {this.props.t("navbar.skills")}
        </a>
        <a href="#contacts" style={{ textDecoration: 'none', color: this.state.current === 4 ? '#363BAE' : '#b7b3b3', margin: '0 1vh', fontSize: '20px', fontWeight: '100' }}>
          {this.props.t("navbar.contacts")}
        </a>
      </nav>
    )
    if (window.innerWidth <= 992) return (
      <div id='mobile_nav'>
        ...
        <div id='mobileNav' style={{
          ...
          <nav>
            <a href="#container" style={{ textDecoration: 'none', color: 'white', padding: '2.3vh 1.5vw', display: 'block', textAlign: 'center', margin: '0 1vh', fontSize: '20px', fontWeight: '100' }}>
              {this.props.t("navbar.home")}
            </a>
            <a href="#history" style={{ textDecoration: 'none', color: 'white', padding: '2.3vh 1.5vw', display: 'block', textAlign: 'center', margin: '0 1vh', fontSize: '20px', fontWeight: '100' }}>
              {this.props.t("navbar.history")}
            </a>
            <a href="#portfolio" style={{ textDecoration: 'none', color: 'white', padding: '2.3vh 1.5vw', display: 'block', textAlign: 'center', margin: '0 1vh', fontSize: '20px', fontWeight: '100' }}>
              {this.props.t("navbar.portfolio")}
            </a>
            <a href="#skills" style={{ textDecoration: 'none', color: 'white', padding: '2.3vh 1.5vw', display: 'block', textAlign: 'center', margin: '0 1vh', fontSize: '20px', fontWeight: '100' }}>
              {this.props.t("navbar.skills")}
            </a>
            <a href="#contacts" style={{ textDecoration: 'none', color: 'white', padding: '2.3vh 1.5vw', display: 'block', textAlign: 'center', margin: '0 1vh', fontSize: '20px', fontWeight: '100' }}>
              {this.props.t("navbar.contacts")}
            </a>
          </nav>
        </div>
